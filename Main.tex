...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{AI-Driven Digital Twin for Smart Energy Optimization in MSMEs Using IoT-Based Energy Analytics}
\subCode{XX367P}
...
\guideDeptA[AIML]{Artificial Intelligence & Machine Learning}
