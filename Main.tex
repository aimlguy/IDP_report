...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{EnerVision: AI-Powered Digital Twin for Predictive Energy Intelligence and Sustainable Manufacturing}
\subCode{XX367P}
% Note: While using the template for IDP, the \Department cmd is not used (discarded automatically) in IDP. The Certificate page uses \guideDeptA[ECE]{Electronics and Communication Engineering} cmd in IDP.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Student Details%%%
\stuNameA{Aaditey Chalva}
\stuUSNA{1RV23AI001}
\stuNameB{Ishita Goyal}
\stuUSNB{1RV23AI039}
\stuNameC{Manoj.R}
\stuUSNC{1RV23CH025}
\stuNameD{Megha Thakur}
\stuUSND{1RV23CH027}
...
\guideNameA{Dr. SriVidya P}
\guideDesignationA{Project Guide / Academic Supervisor}
...
\begin{spacing}{1.5}
	\tableofcontents	
\end{spacing}
\begin{spacing}{1.5}\clearpage\addcontentsline{toc}{chapter}{\listfigurename}
	\listoffigures	
\end{spacing}
\begin{spacing}{1.5}\clearpage\addcontentsline{toc}{chapter}{\listtablename}
	\listoftables	
\end{spacing}
%\newpage
